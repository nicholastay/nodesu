...
class UserComponent extends Component {
    ...
    getBest(user, mode, limit, lookupType) {
        ...
        return this.api.requester.get(ApiConstants.USER_GET_BEST, options, true, true, Score);
    }
    ...
    getRecent(user, mode, limit, lookupType) {
        ...
        return this.api.requester.get(ApiConstants.USER_GET_RECENT, options, true, true, Score);
    }
}
